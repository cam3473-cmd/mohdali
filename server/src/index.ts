...
import { cashSupportsRouter } from "./routes/cashSupports";
import { inKindSupportsRouter } from "./routes/inKindSupports";
...
app.use("/api/cash-supports", cashSupportsRouter);
app.use("/api/in-kind-supports", inKindSupportsRouter);

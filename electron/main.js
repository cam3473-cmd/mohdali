...
async function createWindow() {
  ...
  // تفريغ ذاكرة التخزين المؤقت HTTP في كل تشغيل: المحتوى يُخدَّم من نفس الجهاز (localhost)
  // فتكلفة عدم التخزين المؤقت لا تُذكر، بينما تخزين نسخة قديمة من الواجهة مؤقتاً بالخطأ
  // (من إصدار سابق) يعني ظهور شاشات لا تحتوي إصلاحات حديثة رغم نجاح التحديث والتثبيت.
  // لا يمس هذا بيانات الجلسة (localStorage/رمز الدخول)، فقط الاستجابات المخزَّنة.
